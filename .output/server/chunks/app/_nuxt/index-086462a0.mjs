...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="container mx-auto bg-slate-300 h-full min-h-screen w-full flex flex-wrap gap-4 p-4 mt-18">`);
      if (unref(pending)) {
...
//# sourceMappingURL=index-086462a0.mjs.map

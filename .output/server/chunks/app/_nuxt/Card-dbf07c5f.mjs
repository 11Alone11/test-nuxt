import { computed, unref, reactive, defineComponent, ref, h, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, shallowRef, toRef, getCurrentInstance, onServerPrefetch } from 'vue';
...
import { f as fetchDefaults, a as asyncDataDefaults, u as useNuxtApp, c as createError, b as useRuntimeConfig } from '../server.mjs';
import { u as useHead } from './index-6a088328.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-46d6823b.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-xs flex flex-col gap-4 p-4 border rounded-lg border-black border-4" }, _attrs))}><p class="id">${ssrInterpolate(__props.id)}</p><p class="title">${ssrInterpolate(__props.title)}</p>`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`This is card number ${ssrInterpolate(__props.id)}`);
          } else {
            return [
              createTextVNode("This is card number " + toDisplayString(__props.id), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=Card-dbf07c5f.mjs.map

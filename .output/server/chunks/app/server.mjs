import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, ref, watchEffect, watch, computed, unref, provide, defineComponent as defineComponent$1, capitalize, camelize, h, createVNode, mergeProps, inject as inject$1, shallowReactive, Suspense, nextTick, Transition, toRefs, shallowRef, withDirectives, Fragment, resolveDirective, isRef, toRef, Text, resolveDynamicComponent, onScopeDispose, vShow, reactive, Teleport, cloneVNode, createTextVNode, isVNode, Comment, warn, toRaw, readonly, TransitionGroup, effectScope, createApp, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, isReadonly, markRaw, isShallow, isReactive, withCtx, toDisplayString, openBlock, createBlock, renderList } from 'vue';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-62b507da.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-086462a0.mjs').then((m) => m.default || m)
  },
  {
    name: "Test",
    path: "/Test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Test-d194445c.mjs').then((m) => m.default || m)
  }
];
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VAppBar, {
                    ...
                    append: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VBtn, { icon: "mdi-heart" }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VBtn, { icon: "mdi-magnify" }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VBtn, { icon: "mdi-dots-vertical" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VBreadcrumbs, { items: breadcrumbsItems }, {
                        ...
                        return [
                          createVNode(VBreadcrumbs, { items: breadcrumbsItems }, {
                            prepend: withCtx(() => [
                              createVNode(VIcon, {
                                size: "small",
                                icon: "$vuetify"
                  ...
                  _push3(ssrRenderComponent(VFooter, { class: "bg-indigo-lighten-1 text-center d-flex flex-column" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<!--]--></div><div class="pt-0"${_scopeId3}> Phasellus feugiat arcu sapien, et iaculis ipsum elementum sit amet. Mauris cursus commodo interdum. Praesent ut risus eget metus luctus accumsan id ultrices nunc. Sed at orci sed massa consectetur dignissim a sit amet dui. Duis commodo vitae velit et faucibus. Morbi vehicula lacinia malesuada. Nulla placerat augue vel ipsum ultrices, cursus iaculis dui sollicitudin. Vestibulum eu ipsum vel diam elementum tempor vel ut orci. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. </div>`);
                        _push4(ssrRenderComponent(VDivider, null, null, _parent4, _scopeId3));
                        _push4(`<div${_scopeId3}>${ssrInterpolate(( new Date()).getFullYear())} — <strong${_scopeId3}>Vuetify</strong></div>`);
                      } else {
                        return [
                  ...
                  return [
                    ...
                    createVNode(VFooter, { class: "bg-indigo-lighten-1 text-center d-flex flex-column" }, {
                      default: withCtx(() => [
                        createVNode("div", null, [
                          (openBlock(), createBlock(Fragment, null, renderList(icons, (icon) => {
                            return createVNode(VBtn, {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-a7373bc2.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-19fd1e84.mjs').then((r) => r.default || r));
...
export { makeThemeProps as A, makeVariantProps as B, provideTheme as C, useBorder as D, useVariant as E, useDensity as F, useDimension as G, useElevation as H, IconValue as I, useLoader as J, useLocation as K, usePosition as L, useRounded as M, useLink as N, VImg as O, LoaderSlot as P, genOverlays as Q, Ripple as R, VAvatar as V, useRouter$1 as a, useRuntimeConfig as b, createError as c, navigateTo as d, entry$1 as default, asyncDataDefaults as e, useNuxtApp as f, fetchDefaults as g, genericComponent as h, useRender as i, createSimpleFunctional as j, propsFactory as k, makeDensityProps as l, makeComponentProps as m, nuxtLinkDefaults as n, VDefaultsProvider as o, provideDefaults as p, makeBorderProps as q, makeDimensionProps as r, makeElevationProps as s, makeLoaderProps as t, useHead as u, makeLocationProps as v, makePositionProps as w, makeRoundedProps as x, makeRouterProps as y, makeTagProps as z };
